...
namespace bike.Controls.SKColorDispersionBar
{
    ...
    {
        private static readonly Dictionary<int, (Point startPoint, Point endPoint)> _gradientPointsByAngle =
        ...
        {
            if (_gradientPointsByAngle.TryGetValue(angle, out (Point startPoint, Point endPoint) points))
            {
                return points;
            }
            ...
            _gradientPointsByAngle.Add(angle, result);
